...
public class Consts : MonoBehaviour {
    ...
    public const float ToggleChainDelay = 0.5f;
    public const float ToggleChainDelayReset = 2.0f; //should always be 2 * ToggleChainDelay
    public const float PiPieceJumpForce = 10f;
    public const float PiPieceTransformPeriod = 0.5f;
